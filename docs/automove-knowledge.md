...
- Static selectors over policy labels, branch labels, exact contexts, exact or coarse first-divergence moves, first-divergence move-shape, board-intent, source-board balance buckets, terminal outcome buckets, portfolio-support and winner-count buckets, variants, guarded-selected moves, copied FENs, or singleton-heavy move pairs.
