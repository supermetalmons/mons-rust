...
- Static selectors over policy labels, branch labels, exact contexts, exact or coarse first-divergence moves, variants, guarded-selected moves, copied FENs, or singleton-heavy move pairs.
