...
- Static selectors over policy labels, branch labels, exact contexts, exact or coarse first-divergence moves, first-divergence move-shape or board-intent buckets, variants, guarded-selected moves, copied FENs, or singleton-heavy move pairs.
