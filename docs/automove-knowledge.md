...
- Static selectors over policy labels, branch labels, exact contexts, first moves, variants, guarded-selected moves, copied FENs, or singleton-heavy move pairs.
