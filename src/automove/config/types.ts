...
import { isMonFainted, itemMon, type Input } from "../../engine/model/domain.js";
...
export function hasAwakeSpiritOnBase(game: MonsGame, perspective: Color): boolean {
  ...
  return (
    mon?.kind === MonKind.Spirit && mon.color === perspective && !isMonFainted(mon)
  );
}
