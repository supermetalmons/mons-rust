...
class ExactSessionCaches {
  ...
  public readonly pickupPath = new Hash64Table<ExactDrainerPickupPath | undefined>(
  ...
  public readonly turnTacticalProjection = new Hash64Table<ExactTurnTacticalProjection>(
    EXACT_ANALYSIS_CACHE_MAX_ENTRIES,
  );
...
export function exactCaches(context: AutomoveExecutionContext): ExactSessionCaches {
...
export function exactCacheTag(...values: readonly number[]): number | undefined {
...
export function clearExactStateAnalysisCache(context: AutomoveExecutionContext): void {
