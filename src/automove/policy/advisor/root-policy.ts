...
import { buildSpiritRootProjections } from "../reply-risk/projection.js";
import {
  compareSpiritProjectionPlans,
  spiritProjectionChallengeOrder,
} from "../reply-risk/spirit-ordering.js";
import { spiritFollowupFloorOrder } from "../reply-risk/followup-ordering.js";
import {
...
import { MIN_SCORE, saturatingScoreSubtract } from "../../core/score-math.js";
...
import { canChallengeSpiritPreferenceRootWithRecovery } from "../reply-risk/projection.js";
import {
...
import type { SpiritProjectionMap } from "./competition.js";
import {
...
function comparisonResult(order: number | undefined): ProductionComparisonResult {
...
export function buildRootPolicy(
  ...
  const safetyReentries = (
    ...
    for (const index of recoverySetupIndices) {
      ...
      const recoveryScoreGap = saturatingScoreSubtract(bestSafeScore, root.score);
  ...
  const competitionRules = freezeRules([
    ...
    },
    {
      ...
      evaluate: (context: RootSelectionContext) =>
        competitionResult(negativeDenyCompetition(context, projections(context))),
    },
    {
