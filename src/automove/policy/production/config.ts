...
export function productionMidTurnTacticalGuardLive(config: AutomoveConfig): boolean {
  return productionTurnEngineLive(config) && config.planner.midTurnTacticalGuard;
}

export function productionIsWhiteTurnOneManaOnlyFollowup(game: MonsGame): boolean {
  return (
