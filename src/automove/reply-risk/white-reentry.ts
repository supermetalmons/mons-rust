...
import type { TurnUtility } from "../turn-engine.js";
import { turnEngineRootPlanUtility } from "./projection.js";
import { rankedRootOrder, sameNonTacticalProgressLane } from "./ranking.js";
...
export function productionWhiteTurnFourManaSiblingReentry(
  ...
  evaluations.forEach((candidate, index) => {
    ...
    const dominance =
      utilityOrder > 0 ||
      utilityStrictlyDominatesOverrideAxes(utility, anchorUtility);
