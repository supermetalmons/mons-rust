...
fn probe_config_with_env_overrides(mut config: SmartSearchConfig) -> SmartSearchConfig {
    ...
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_LAZY_ORACLE_SCORE_WINDOW_PROJECTION") {
        config.enable_turn_engine_lazy_oracle_score_window_projection = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_LATE_BLACK_SETUP_PROGRESS_RESCUE") {
        config.enable_turn_engine_late_black_setup_progress_rescue = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_SUPERMANA_PREPASS_EXCEPTION") {
        config.enable_supermana_prepass_exception = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_OPPONENT_MANA_PREPASS_EXCEPTION") {
        config.enable_opponent_mana_prepass_exception = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_MANA_START_MIX_WITH_POTION_ACTIONS") {
        config.enable_mana_start_mix_with_potion_actions = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_POTION_PROGRESS_COMPENSATION") {
        config.enable_potion_progress_compensation = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_WALK_THREAT_PREFILTER") {
        config.enable_walk_threat_prefilter = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_KILLER_MOVE_ORDERING") {
        config.enable_killer_move_ordering = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_HISTORY_HEURISTIC") {
        config.enable_history_heuristic = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_PVS") {
        config.enable_pvs = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_TARGETED_EXACT_TURN_SUMMARY_MEMO") {
        config.enable_turn_planner_targeted_exact_turn_summary_memo = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_TARGETED_SCORE_WINDOW_NARROWING") {
        config.enable_turn_planner_targeted_score_window_narrowing = value;
    }
    ...
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_ROOT_REPLY_RISK_GUARD") {
        config.enable_root_reply_risk_guard = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_FORCED_TACTICAL_PREPASS") {
        config.enable_forced_tactical_prepass = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_ROOT_EXACT_TACTICS") {
        config.enable_root_exact_tactics = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_CHILD_EXACT_TACTICS") {
        config.enable_child_exact_tactics = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_STATIC_EXACT_EVALUATION") {
        config.enable_static_exact_evaluation = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_EXACT_LITE_PROGRESS_CHECKS") {
        config.enable_exact_lite_progress_checks = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_EXACT_LITE_SPIRIT_WINDOW_CHECKS") {
        config.enable_exact_lite_spirit_window_checks = value;
    }
    if let Some(value) = env_usize("SMART_PROBE_FORCE_EXACT_LITE_ROOT_CALL_BUDGET") {
        config.exact_lite_root_call_budget = value;
    }
    if let Some(value) = env_usize("SMART_PROBE_FORCE_EXACT_LITE_STATIC_CALL_BUDGET") {
        config.exact_lite_static_call_budget = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_ROOT_DRAINER_SAFETY_PREFILTER") {
        config.enable_root_drainer_safety_prefilter = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_ROOT_SPIRIT_DEVELOPMENT_PREF") {
        config.enable_root_spirit_development_pref = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_CHILD_EVAL_BUNDLE") {
        config.enable_child_eval_bundle = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_LOCAL_SCORING_EVAL_CTX") {
        config.enable_local_scoring_eval_ctx = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_SCORING_ATTACK_REACH_SUMMARY") {
        config.enable_scoring_attack_reach_summary = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_SCORING_ATTACK_REACH_TARGET_NARROWING")
    {
        config.enable_scoring_attack_reach_target_narrowing = value;
    }
    if let Some(value) =
        env_bool_value("SMART_PROBE_FORCE_SCORING_DRAINER_ATTACK_REACH_TARGET_NARROWING")
    {
        config.enable_scoring_drainer_attack_reach_target_narrowing = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_CHILD_VULNERABILITY_SCORING_CTX_REUSE")
    {
        config.enable_child_vulnerability_scoring_ctx_reuse = value;
    }
    if let Some(value) =
        env_bool_value("SMART_PROBE_FORCE_CHILD_VULNERABILITY_ATTACK_PLAUSIBILITY_SCREEN")
    {
        config.enable_child_vulnerability_attack_plausibility_screen = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_TWO_STAGE_CHILD_ORDERING") {
        config.enable_two_stage_child_ordering = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_ROOT_EFFICIENCY") {
        config.enable_root_efficiency = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_ENHANCED_DRAINER_VULNERABILITY") {
        config.enable_enhanced_drainer_vulnerability = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_LOW_BUDGET_GUARD") {
        config.enable_turn_engine_low_budget_guard = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_TURN_ENGINE_ELIGIBILITY_GUARD") {
        config.enable_turn_engine_eligibility_guard = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_MID_TURN_PROGRESS_GUARD") {
        config.enable_turn_engine_mid_turn_progress_guard = value;
    }
    ...
    if let Some(value) = env_usize("SMART_PROBE_FORCE_TURN_ENGINE_SEED_CAP") {
        config.turn_engine_seed_cap = value.max(1);
    }
    if let Some(value) = env_usize("SMART_PROBE_FORCE_TURN_ENGINE_BEAM_WIDTH") {
        config.turn_engine_beam_width = value.max(1);
    }
    if let Some(value) = env_usize("SMART_PROBE_FORCE_TURN_ENGINE_PER_NODE_FAMILY_CAP") {
        config.turn_engine_per_node_family_cap = value.max(1);
    }
    if let Some(value) = env_usize("SMART_PROBE_FORCE_TURN_ENGINE_STEP_CAP") {
        config.turn_engine_step_cap = value.max(1);
    }
    if let Some(value) = env_usize("SMART_PROBE_FORCE_TURN_ENGINE_OPPONENT_SEED_CAP") {
        config.turn_engine_opponent_seed_cap = value.max(1);
    }
    if let Some(value) = env_usize("SMART_PROBE_FORCE_TURN_ENGINE_OPPONENT_BEAM_WIDTH") {
        config.turn_engine_opponent_beam_width = value.max(1);
    }
    if let Some(value) = env_usize("SMART_PROBE_FORCE_TURN_ENGINE_REPLY_SEED_CAP") {
        config.turn_engine_reply_seed_cap = value.max(1);
    }
    if let Some(value) = env_usize("SMART_PROBE_FORCE_TURN_ENGINE_REPLY_BEAM_WIDTH") {
        config.turn_engine_reply_beam_width = value.max(1);
    }
    if let Some(value) = env_usize("SMART_PROBE_FORCE_TURN_ENGINE_EXPANSION_CAP") {
        config.turn_engine_expansion_cap = value.max(1);
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_TURN_ENGINE_ENABLE_SPIRIT_FAMILY") {
        config.turn_engine_enable_spirit_family = value;
    }
    ...
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_ROOT_ASPIRATION") {
        config.enable_root_aspiration = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_TT_BEST_CHILD_ORDERING") {
        config.enable_tt_best_child_ordering = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_BACKTRACK_PENALTY") {
        config.enable_backtrack_penalty = value;
    }
    if let Some(value) = env_i32("SMART_PROBE_FORCE_ROOT_BACKTRACK_PENALTY") {
        config.root_backtrack_penalty = value.max(0);
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_ROOT_MANA_HANDOFF_GUARD") {
        config.enable_root_mana_handoff_guard = value;
    }
    if let Some(value) = env_i32("SMART_PROBE_FORCE_ROOT_MANA_HANDOFF_PENALTY") {
        config.root_mana_handoff_penalty = value.max(0);
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_FORCED_DRAINER_ATTACK") {
        config.enable_forced_drainer_attack = value;
    }
    ...
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_STRICT_TACTICAL_CLASS_COVERAGE") {
        config.enable_strict_tactical_class_coverage = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_CHILD_MOVE_CLASS_COVERAGE") {
        config.enable_child_move_class_coverage = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_MOVE_CLASS_COVERAGE") {
        config.enable_move_class_coverage = value;
    }
    ...
    if let Some(value) = env_usize("SMART_PROBE_FORCE_MAX_EXTENSIONS_PER_PATH") {
        config.max_extensions_per_path = value;
    }
    ...
    if let Some(value) = env_i32("SMART_PROBE_FORCE_ANTI_HELP_MARGIN") {
        config.root_anti_help_score_margin = value.max(0);
    }
    if let Some(value) = env_usize("SMART_PROBE_FORCE_ANTI_HELP_REPLY_LIMIT") {
        config.root_anti_help_reply_limit = value.max(1);
    }
    ...
    if let Some(value) = env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_SCORE_MARGIN") {
        config.interview_soft_score_margin = value.max(0);
    }
    if let Some(value) = env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_SUPERMANA_PROGRESS_BONUS") {
        config.interview_soft_supermana_progress_bonus = value.max(0);
    }
    if let Some(value) = env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_SUPERMANA_SCORE_BONUS") {
        config.interview_soft_supermana_score_bonus = value.max(0);
    }
    if let Some(value) = env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_OPPONENT_MANA_PROGRESS_BONUS")
    {
        config.interview_soft_opponent_mana_progress_bonus = value.max(0);
    }
    if let Some(value) = env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_OPPONENT_MANA_SCORE_BONUS") {
        config.interview_soft_opponent_mana_score_bonus = value.max(0);
    }
    if let Some(value) = env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_MANA_HANDOFF_PENALTY") {
        config.interview_soft_mana_handoff_penalty = value.max(0);
    }
    if let Some(value) = env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_ROUNDTRIP_PENALTY") {
        config.interview_soft_roundtrip_penalty = value.max(0);
    }
    if let Some(value) = env_i32("SMART_PROBE_FORCE_POTION_SPEND_PENALTY_FAST") {
        config.potion_spend_penalty_fast = value.max(0);
    }
    if let Some(value) = env_i32("SMART_PROBE_FORCE_POTION_SPEND_PENALTY_NORMAL") {
        config.potion_spend_penalty_normal = value.max(0);
    }
    ...
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_TT_DEPTH_PREFERRED_REPLACEMENT") {
        config.enable_tt_depth_preferred_replacement = value;
    }
    if let Some(value) = env_bool_value("SMART_PROBE_FORCE_ITERATIVE_DEEPENING") {
        config.enable_iterative_deepening = value;
    }
    if let Some(value) = env_usize("SMART_PROBE_FORCE_ITERATIVE_DEEPENING_DEPTH_OFFSET") {
        config.iterative_deepening_depth_offset = value;
    }
    if let Some(value) = env_i32("SMART_PROBE_FORCE_ITERATIVE_DEEPENING_ALPHA_MARGIN") {
        config.iterative_deepening_alpha_margin = value.max(0);
    }
    config
}
...
fn run_smart_automove_pro_reliability_surface_probe(
    ...
    let mut repeated_surface_count = 0usize;
    let mut repeated_internal_surface_count = 0usize;
    let mut repeated_non_pro_owned_surface_count = 0usize;
    let mut repeated_internal_non_pro_owned_surface_count = 0usize;
    let mut total_internal_exacts = 0usize;

    for (surface_key, stats) in &surface_stats {
        total_internal_exacts += stats.internal_exacts;
        let repeated = stats.exacts > 1;
        let non_pro_owned = stats.pro_matches_candidate == 0;
        if repeated {
            repeated_surface_count += 1;
        }
        if repeated && stats.internal_exacts > 0 {
            repeated_internal_surface_count += 1;
        }
        if repeated && non_pro_owned {
            repeated_non_pro_owned_surface_count += 1;
        }
        if repeated && non_pro_owned && stats.internal_exacts > 0 {
            repeated_internal_non_pro_owned_surface_count += 1;
        }
    ...
    eprintln!(
        ...
        repeated_non_pro_owned_surface_count,
        repeated_internal_non_pro_owned_surface_count,
        total_internal_exacts,
    );
...
fn smart_automove_pro_reliability_override_delta_probe() {
    ...
    eprintln!(
        "pro reliability override delta probe config: candidate_profile={} baseline_profile={} baseline_mode={:?} seed_tag={} repeats={} games_per_repeat={} max_plies={} include_acceptance={} trace_limit={} override_engine_disabled={:?} override_max_nodes={:?} override_root_limit={:?} override_enum_limit={:?} override_node_limit={:?} override_node_enum_limit={:?} override_secondary_analysis={:?} override_selected_followup_projection={:?} override_lazy_oracle_score_window_projection={:?} override_late_black_setup_progress_rescue={:?} override_supermana_prepass_exception={:?} override_opponent_mana_prepass_exception={:?} override_mana_start_mix_with_potion_actions={:?} override_potion_progress_compensation={:?} override_walk_threat_prefilter={:?} override_killer_move_ordering={:?} override_history_heuristic={:?} override_pvs={:?} override_targeted_exact_turn_summary_memo={:?} override_targeted_score_window_narrowing={:?} override_move_efficiency_tactical_narrowing={:?} override_futility={:?} override_futility_margin={:?} override_root_reply_risk_guard={:?} override_forced_tactical_prepass={:?} override_child_eval_bundle={:?} override_local_scoring_eval_ctx={:?} override_scoring_attack_reach_summary={:?} override_scoring_attack_reach_target_narrowing={:?} override_scoring_drainer_attack_reach_target_narrowing={:?} override_child_vulnerability_scoring_ctx_reuse={:?} override_child_vulnerability_attack_plausibility_screen={:?} override_two_stage_child_ordering={:?} override_root_efficiency={:?} override_enhanced_drainer_vulnerability={:?} override_root_aspiration={:?} override_tt_best_child_ordering={:?} override_backtrack_penalty={:?} override_root_backtrack_penalty={:?} override_root_mana_handoff_guard={:?} override_root_mana_handoff_penalty={:?} override_strict_anti_help_filter={:?} override_strict_tactical_class_coverage={:?} override_child_move_class_coverage={:?} override_move_class_coverage={:?} override_focus_k={:?} override_focus_share_bp={:?} override_reply_limit={:?} override_reply_share_bp={:?} override_reply_margin={:?} override_anti_help_margin={:?} override_anti_help_reply_limit={:?} override_drainer_margin={:?} override_efficiency_margin={:?} override_exact_lite_root_call_budget={:?} override_exact_lite_static_call_budget={:?} override_selective_extension_share_bp={:?} override_max_extensions_per_path={:?} override_shortlist_max={:?} override_quiet_reductions={:?} override_quiet_reduction_depth={:?} override_interview_soft_supermana_progress_bonus={:?} override_interview_soft_supermana_score_bonus={:?} override_interview_soft_mana_handoff_penalty={:?} override_interview_soft_roundtrip_penalty={:?} override_potion_spend_penalty_fast={:?} override_potion_spend_penalty_normal={:?} override_quiescence={:?} override_quiescence_tactical_only={:?} override_quiescence_budget={:?} override_quiescence_enum_limit={:?} override_low_budget_guard={:?} override_turn_engine_eligibility_guard={:?} override_mid_turn_progress_guard={:?} override_mid_turn_tactical_guard={:?} override_late_safe_mana_root_preference={:?}",
        candidate_profile,
        baseline_profile,
        baseline_mode,
        seed_tag,
        ...
        include_acceptance,
        trace_limit,
        env_bool("SMART_PROBE_FORCE_ENGINE_DISABLED"),
        ...
        env_bool("SMART_PROBE_FORCE_LAZY_ORACLE_SCORE_WINDOW_PROJECTION"),
        env_bool("SMART_PROBE_FORCE_LATE_BLACK_SETUP_PROGRESS_RESCUE"),
        env_bool("SMART_PROBE_FORCE_SUPERMANA_PREPASS_EXCEPTION"),
        env_bool("SMART_PROBE_FORCE_OPPONENT_MANA_PREPASS_EXCEPTION"),
        env_bool("SMART_PROBE_FORCE_MANA_START_MIX_WITH_POTION_ACTIONS"),
        env_bool("SMART_PROBE_FORCE_POTION_PROGRESS_COMPENSATION"),
        env_bool("SMART_PROBE_FORCE_WALK_THREAT_PREFILTER"),
        env_bool("SMART_PROBE_FORCE_KILLER_MOVE_ORDERING"),
        env_bool("SMART_PROBE_FORCE_HISTORY_HEURISTIC"),
        env_bool("SMART_PROBE_FORCE_PVS"),
        ...
        env_bool("SMART_PROBE_FORCE_ROOT_REPLY_RISK_GUARD"),
        env_bool("SMART_PROBE_FORCE_FORCED_TACTICAL_PREPASS"),
        env_bool("SMART_PROBE_FORCE_CHILD_EVAL_BUNDLE"),
        env_bool("SMART_PROBE_FORCE_LOCAL_SCORING_EVAL_CTX"),
        env_bool("SMART_PROBE_FORCE_SCORING_ATTACK_REACH_SUMMARY"),
        env_bool("SMART_PROBE_FORCE_SCORING_ATTACK_REACH_TARGET_NARROWING"),
        env_bool("SMART_PROBE_FORCE_SCORING_DRAINER_ATTACK_REACH_TARGET_NARROWING"),
        env_bool("SMART_PROBE_FORCE_CHILD_VULNERABILITY_SCORING_CTX_REUSE"),
        env_bool("SMART_PROBE_FORCE_CHILD_VULNERABILITY_ATTACK_PLAUSIBILITY_SCREEN"),
        env_bool("SMART_PROBE_FORCE_TWO_STAGE_CHILD_ORDERING"),
        env_bool("SMART_PROBE_FORCE_ROOT_EFFICIENCY"),
        env_bool("SMART_PROBE_FORCE_ENHANCED_DRAINER_VULNERABILITY"),
        env_bool("SMART_PROBE_FORCE_ROOT_ASPIRATION"),
        env_bool("SMART_PROBE_FORCE_TT_BEST_CHILD_ORDERING"),
        env_bool("SMART_PROBE_FORCE_BACKTRACK_PENALTY"),
        env_i32("SMART_PROBE_FORCE_ROOT_BACKTRACK_PENALTY"),
        env_bool("SMART_PROBE_FORCE_ROOT_MANA_HANDOFF_GUARD"),
        env_i32("SMART_PROBE_FORCE_ROOT_MANA_HANDOFF_PENALTY"),
        ...
        env_bool("SMART_PROBE_FORCE_MOVE_CLASS_COVERAGE"),
        env_usize("SMART_PROBE_FORCE_FOCUS_K"),
        env_i32("SMART_PROBE_FORCE_FOCUS_SHARE_BP"),
        env_usize("SMART_PROBE_FORCE_REPLY_LIMIT"),
        env_i32("SMART_PROBE_FORCE_REPLY_SHARE_BP"),
        env_i32("SMART_PROBE_FORCE_REPLY_MARGIN"),
        env_i32("SMART_PROBE_FORCE_ANTI_HELP_MARGIN"),
        env_usize("SMART_PROBE_FORCE_ANTI_HELP_REPLY_LIMIT"),
        env_i32("SMART_PROBE_FORCE_DRAINER_MARGIN"),
        env_i32("SMART_PROBE_FORCE_EFFICIENCY_MARGIN"),
        env_usize("SMART_PROBE_FORCE_EXACT_LITE_ROOT_CALL_BUDGET"),
        env_usize("SMART_PROBE_FORCE_EXACT_LITE_STATIC_CALL_BUDGET"),
        env_i32("SMART_PROBE_FORCE_SELECTIVE_EXTENSION_SHARE_BP"),
        env_usize("SMART_PROBE_FORCE_MAX_EXTENSIONS_PER_PATH"),
        env_usize("SMART_PROBE_FORCE_SHORTLIST_MAX"),
        env_bool("SMART_PROBE_FORCE_QUIET_REDUCTIONS"),
        env_usize("SMART_PROBE_FORCE_QUIET_REDUCTION_DEPTH"),
        env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_SUPERMANA_PROGRESS_BONUS"),
        env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_SUPERMANA_SCORE_BONUS"),
        env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_MANA_HANDOFF_PENALTY"),
        env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_ROUNDTRIP_PENALTY"),
        env_i32("SMART_PROBE_FORCE_POTION_SPEND_PENALTY_FAST"),
        env_i32("SMART_PROBE_FORCE_POTION_SPEND_PENALTY_NORMAL"),
        ...
        env_usize("SMART_PROBE_FORCE_QUIESCENCE_ENUM_LIMIT"),
        env_bool("SMART_PROBE_FORCE_LOW_BUDGET_GUARD"),
        env_bool("SMART_PROBE_FORCE_TURN_ENGINE_ELIGIBILITY_GUARD"),
        env_bool("SMART_PROBE_FORCE_MID_TURN_PROGRESS_GUARD"),
...
fn smart_automove_pro_reliability_candidate_override_probe() {
    ...
    eprintln!(
        "pro reliability candidate override probe config: candidate_profile={} baseline_profile={} seed_tag_pro={} seed_tag_normal={} repeats={} games_per_repeat={} max_plies={} include_acceptance={} override_turn_planner_root_injection={:?} override_turn_planner_root_injection_limit={:?} override_turn_planner_root_max_gap={:?} override_turn_planner_root_emergency_only={:?} override_engine_disabled={:?} override_max_nodes={:?} override_root_limit={:?} override_enum_limit={:?} override_node_limit={:?} override_node_enum_limit={:?} override_secondary_analysis={:?} override_selected_followup_projection={:?} override_lazy_oracle_score_window_projection={:?} override_late_black_setup_progress_rescue={:?} override_supermana_prepass_exception={:?} override_opponent_mana_prepass_exception={:?} override_mana_start_mix_with_potion_actions={:?} override_potion_progress_compensation={:?} override_walk_threat_prefilter={:?} override_killer_move_ordering={:?} override_history_heuristic={:?} override_pvs={:?} override_targeted_exact_turn_summary_memo={:?} override_targeted_score_window_narrowing={:?} override_move_efficiency_tactical_narrowing={:?} override_futility={:?} override_futility_margin={:?} override_root_reply_risk_guard={:?} override_forced_tactical_prepass={:?} override_root_exact_tactics={:?} override_child_exact_tactics={:?} override_static_exact_evaluation={:?} override_exact_lite_progress_checks={:?} override_exact_lite_spirit_window_checks={:?} override_exact_lite_root_call_budget={:?} override_exact_lite_static_call_budget={:?} override_root_drainer_safety_prefilter={:?} override_root_spirit_development_pref={:?} override_child_eval_bundle={:?} override_local_scoring_eval_ctx={:?} override_scoring_attack_reach_summary={:?} override_scoring_attack_reach_target_narrowing={:?} override_scoring_drainer_attack_reach_target_narrowing={:?} override_child_vulnerability_scoring_ctx_reuse={:?} override_child_vulnerability_attack_plausibility_screen={:?} override_two_stage_child_ordering={:?} override_root_efficiency={:?} override_enhanced_drainer_vulnerability={:?} override_root_aspiration={:?} override_tt_best_child_ordering={:?} override_backtrack_penalty={:?} override_root_backtrack_penalty={:?} override_root_mana_handoff_guard={:?} override_root_mana_handoff_penalty={:?} override_forced_drainer_attack={:?} override_forced_drainer_attack_fallback={:?} override_targeted_drainer_attack_fallback={:?} override_per_mon_drainer_attack_fallback={:?} override_drainer_attack_priority_enum={:?} override_drainer_attack_priority_enum_boost={:?} override_drainer_attack_minimax_selection={:?} override_drainer_attack_full_pool={:?} override_conditional_forced_drainer_attack={:?} override_conditional_forced_attack_score_margin={:?} override_strict_anti_help_filter={:?} override_strict_tactical_class_coverage={:?} override_child_move_class_coverage={:?} override_move_class_coverage={:?} override_two_pass_root_allocation={:?} override_volatility_focus={:?} override_event_ordering={:?} override_selective_extensions={:?} override_focus_k={:?} override_focus_share_bp={:?} override_reply_limit={:?} override_reply_share_bp={:?} override_reply_margin={:?} override_anti_help_margin={:?} override_anti_help_reply_limit={:?} override_drainer_margin={:?} override_efficiency_margin={:?} override_selective_extension_share_bp={:?} override_max_extensions_per_path={:?} override_shortlist_max={:?} override_quiet_reductions={:?} override_quiet_reduction_depth={:?} override_normal_safety_rerank={:?} override_normal_safety_deep_floor={:?} override_clean_reply={:?} override_hard_spirit_deploy={:?} override_soft_root_priors={:?} override_deterministic_tiebreak={:?} override_interview_soft_score_margin={:?} override_interview_soft_supermana_progress_bonus={:?} override_interview_soft_supermana_score_bonus={:?} override_interview_soft_opponent_mana_progress_bonus={:?} override_interview_soft_opponent_mana_score_bonus={:?} override_interview_soft_mana_handoff_penalty={:?} override_interview_soft_roundtrip_penalty={:?} override_potion_spend_penalty_fast={:?} override_potion_spend_penalty_normal={:?} override_quiescence={:?} override_quiescence_tactical_only={:?} override_quiescence_budget={:?} override_quiescence_enum_limit={:?} override_tt_depth_preferred_replacement={:?} override_iterative_deepening={:?} override_iterative_deepening_depth_offset={:?} override_iterative_deepening_alpha_margin={:?} override_low_budget_guard={:?} override_turn_engine_eligibility_guard={:?} override_mid_turn_progress_guard={:?} override_mid_turn_tactical_guard={:?} override_late_safe_mana_root_preference={:?} override_turn_engine_seed_cap={:?} override_turn_engine_beam_width={:?} override_turn_engine_per_node_family_cap={:?} override_turn_engine_step_cap={:?} override_turn_engine_opponent_seed_cap={:?} override_turn_engine_opponent_beam_width={:?} override_turn_engine_reply_seed_cap={:?} override_turn_engine_reply_beam_width={:?} override_turn_engine_expansion_cap={:?} override_turn_engine_enable_spirit_family={:?}",
        candidate_profile,
        baseline_profile,
        seed_tag_pro,
        seed_tag_normal,
        ...
        env_bool("SMART_PROBE_FORCE_ROOT_REPLY_RISK_GUARD"),
        env_bool("SMART_PROBE_FORCE_FORCED_TACTICAL_PREPASS"),
        env_bool("SMART_PROBE_FORCE_ROOT_EXACT_TACTICS"),
        env_bool("SMART_PROBE_FORCE_CHILD_EXACT_TACTICS"),
        env_bool("SMART_PROBE_FORCE_STATIC_EXACT_EVALUATION"),
        env_bool("SMART_PROBE_FORCE_EXACT_LITE_PROGRESS_CHECKS"),
        env_bool("SMART_PROBE_FORCE_EXACT_LITE_SPIRIT_WINDOW_CHECKS"),
        env_usize("SMART_PROBE_FORCE_EXACT_LITE_ROOT_CALL_BUDGET"),
        env_usize("SMART_PROBE_FORCE_EXACT_LITE_STATIC_CALL_BUDGET"),
        env_bool("SMART_PROBE_FORCE_ROOT_DRAINER_SAFETY_PREFILTER"),
        env_bool("SMART_PROBE_FORCE_ROOT_SPIRIT_DEVELOPMENT_PREF"),
        env_bool("SMART_PROBE_FORCE_CHILD_EVAL_BUNDLE"),
        env_bool("SMART_PROBE_FORCE_LOCAL_SCORING_EVAL_CTX"),
        env_bool("SMART_PROBE_FORCE_SCORING_ATTACK_REACH_SUMMARY"),
        env_bool("SMART_PROBE_FORCE_SCORING_ATTACK_REACH_TARGET_NARROWING"),
        ...
        env_bool("SMART_PROBE_FORCE_HARD_SPIRIT_DEPLOY"),
        env_bool("SMART_PROBE_FORCE_SOFT_ROOT_PRIORS"),
        env_bool("SMART_PROBE_FORCE_DETERMINISTIC_TIEBREAK"),
        env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_SCORE_MARGIN"),
        env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_SUPERMANA_PROGRESS_BONUS"),
        env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_SUPERMANA_SCORE_BONUS"),
        env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_OPPONENT_MANA_PROGRESS_BONUS"),
        env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_OPPONENT_MANA_SCORE_BONUS"),
        env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_MANA_HANDOFF_PENALTY"),
        env_i32("SMART_PROBE_FORCE_INTERVIEW_SOFT_ROUNDTRIP_PENALTY"),
        env_i32("SMART_PROBE_FORCE_POTION_SPEND_PENALTY_FAST"),
        env_i32("SMART_PROBE_FORCE_POTION_SPEND_PENALTY_NORMAL"),
        ...
        env_usize("SMART_PROBE_FORCE_QUIESCENCE_BUDGET"),
        env_usize("SMART_PROBE_FORCE_QUIESCENCE_ENUM_LIMIT"),
        env_bool("SMART_PROBE_FORCE_TT_DEPTH_PREFERRED_REPLACEMENT"),
        env_bool("SMART_PROBE_FORCE_ITERATIVE_DEEPENING"),
        env_usize("SMART_PROBE_FORCE_ITERATIVE_DEEPENING_DEPTH_OFFSET"),
        env_i32("SMART_PROBE_FORCE_ITERATIVE_DEEPENING_ALPHA_MARGIN"),
        env_bool("SMART_PROBE_FORCE_LOW_BUDGET_GUARD"),
        env_bool("SMART_PROBE_FORCE_TURN_ENGINE_ELIGIBILITY_GUARD"),
        env_bool("SMART_PROBE_FORCE_MID_TURN_PROGRESS_GUARD"),
        env_bool("SMART_PROBE_FORCE_MID_TURN_TACTICAL_GUARD"),
        env_bool("SMART_PROBE_FORCE_LATE_SAFE_MANA_ROOT_PREFERENCE"),
        env_usize("SMART_PROBE_FORCE_TURN_ENGINE_SEED_CAP"),
        env_usize("SMART_PROBE_FORCE_TURN_ENGINE_BEAM_WIDTH"),
        env_usize("SMART_PROBE_FORCE_TURN_ENGINE_PER_NODE_FAMILY_CAP"),
        env_usize("SMART_PROBE_FORCE_TURN_ENGINE_STEP_CAP"),
        env_usize("SMART_PROBE_FORCE_TURN_ENGINE_OPPONENT_SEED_CAP"),
        env_usize("SMART_PROBE_FORCE_TURN_ENGINE_OPPONENT_BEAM_WIDTH"),
        env_usize("SMART_PROBE_FORCE_TURN_ENGINE_REPLY_SEED_CAP"),
        env_usize("SMART_PROBE_FORCE_TURN_ENGINE_REPLY_BEAM_WIDTH"),
        env_usize("SMART_PROBE_FORCE_TURN_ENGINE_EXPANSION_CAP"),
        env_bool("SMART_PROBE_FORCE_TURN_ENGINE_ENABLE_SPIRIT_FAMILY"),
    );
