...
- current active Fast lower-live safe-step / ManaTempo pressure, ProV4 root-pool, guarded-delta, root-ordering profile, move-efficiency delta, scoring-context robustness, root-preservation, reply-floor, root-safety, utility/rank, cross-budget static-eval consensus, turn-completion stability, two-turn resilience, forced-root feature-axis, root-pool provenance, forced-root pool JSONL, root trajectory, race geometry, root-pool contrast, outcome contrast, family-overlap, state-discriminator, broad token, vulnerable-baseline token, or utility/rank token-pair evidence;
