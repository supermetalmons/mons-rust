...
- Latest diagnostic close (`2026-04-09`, latest):
  ...
  - the seed still failed to line up on one live branch story: direct Pro only replayed one-off early-black `negative_deny` `l0,5;l1,6` vs `l1,5;l3,6;l2,7` and one-off black `ManaTempo` tie `l1,2;l1,1` vs `l1,2;l0,1`; Normal only mixed one-off white spirit-own-setup `l9,5;l7,4;l8,3` vs `l9,5;l7,6;l7,7` with one-off black accepted spirit rerank `l2,5;l0,6;l1,6` vs `l2,5;l2,3;l1,2`; Fast added the already-classified white `l10,4;l9,3` rerank twice plus one-off black `ManaTempo` tie `l2,7;l2,8` vs `l2,7;l1,8`, one-off white forced-prepass `l8,4;l8,5` vs `l8,4;l8,3`, and one-off white safe-progress drift `l8,5;l7,5` vs `l6,0;l5,0;mb`
  - direct conclusion: kill `v73` at diagnostics and keep only the note; even the repeated Fast white pair is an already-classified one-off family with no retained foothold, and the retained churn probe still exposes no shared selector family worth code
- Latest diagnostic close (`2026-04-09`, latest):
...
- Latest diagnostic close (`2026-04-09`, latest):
  ...
  - the widened black runtime probe showed the new Fast `l1,6;l2,7` board is another distinct accepted black runtime surface, not the retained `primary_black_turn_four_action_mana_ply15` seam: runtime-faithful v30 still selects and heads on forced `l1,6;l2,7` with `head_family=SafeSupermanaProgress` and `goal_family=ImmediateScore`, but `pre_accept` and baseline both stay on current `l2,3;l3,4`
  - direct conclusion: keep the widened black runtime probe, but kill `v69` at diagnostics; the current `l2,3;l3,4` baseline still branches beyond the retained later-black seam, so one cross-bucket replay is not enough for code
- Latest diagnostic close (`2026-04-09`, latest):
...
- Latest diagnostic close (`2026-04-09`, latest):
  - refreshed `smart_automove_pro_reliability_duel_trace_probe` with `SMART_PRO_RELIABILITY_SEED_TAG=pro_turn_planner_reliability_v67`
  - duel summary: direct Pro finished `1` regression / `4` improvements / `7` flat, Normal `2` / `1` / `9`, and Fast `5` / `2` / `5`, with every exact move pair still at count `1`
  - the sample did not converge on one new live family: direct Pro only showed one-off white `l9,6;l8,5` vs current `l9,6;l8,7`; Normal only mixed one-off early-black `negative_deny` `l0,5;l1,6` vs `l1,5;l3,6;l2,7` plus one return of the already-killed white `ManaTempo` tie `l6,5;l6,6` vs `l6,5;l7,4`; Fast fractured across one-off black spirit-bridge `l1,5;l1,7;l0,7` vs `l4,1;l5,0;mb`, one-off white forced-prepass `l8,4;l8,5` vs `l8,4;l9,3`, one-off black drainer-safety `l1,4;l2,3` vs `l1,6;l1,5`, one-off black `ManaTempo` tie `l2,7;l2,8` vs `l7,1;l6,1`, and one-off black spirit rerank `l2,4;l0,6;l1,6` vs `l1,7;l2,6`
  - direct conclusion: kill `v67` at diagnostics and keep only the note; the old Normal white `l6,5;l6,6` tie is still weaker than one cross-bucket exact family, and Fast remains too fragmented to justify a production split
...
- Immediate next split:
  ...
  - do not spend from `pro_turn_planner_reliability_v43`; direct Pro finished `1/4/7`, Normal finished clean at `0/4/8`, and Fast `3/3/6`; the only direct-Pro regression was the old black action+mana seam `l1,6;l2,7` vs current `l3,2;l4,1`, but Fast still split across one-off black spirit-bridge `l1,5;l1,7;l0,7` vs `l4,1;l5,0;mb`, one-off white `l10,4;l9,3` vs `l9,5;l7,6;l8,7`, and one-off white `l8,3;l8,2` vs `l8,3;l9,2`, so there is still no repeated exact family with a retained shared lever
  - do not spend from `pro_turn_planner_reliability_v44`; direct Pro finished `2/4/6`, Normal `1/3/8`, and Fast `3/3/6`; every exact move pair still stayed at count `1`, so the seed only mixed one-off direct-Pro black spirit sibling `l0,4;l1,3` vs `l0,4;l1,4`, one-off direct-Pro black accepted safe-progress `l3,5;l4,4` vs `l1,5;l3,5;l3,6`, one-off Normal white `l9,4;l8,5` vs `l9,4;l8,3` where runtime-faithful selection already matched current, and one-off Fast black spirit-bridge `l1,5;l1,7;l0,7` vs `l4,1;l5,0;mb`, black action+mana `l1,6;l2,7` vs `l3,2;l4,1`, and white spirit head `l4,9;l4,7;l3,7` vs `l4,9;l3,9`
  - do not spend from `pro_turn_planner_reliability_v45`; direct Pro finished `3/2/7`, Normal `4/2/6`, and Fast finished clean at `0/4/8`; Normal did repeat the old black spirit-bridge seam `l1,5;l1,7;l0,7` vs current `l4,1;l5,0;mb` twice, but that is still the already-killed bridge-fallback family, while direct Pro mixed one-off black spirit sibling `l0,4;l1,3` vs `l0,4;l1,5`, one-off black mana-bridge `l0,5;l1,4` vs `l4,1;l5,0;mb`, and one-off black spirit rerank `l1,5;l2,3;l3,3` vs `l1,5;l2,7;l1,8`, so there is still no repeated exact family with a fresh shared lever
  - do not spend from `pro_turn_planner_reliability_v46`; direct Pro finished `2/5/5`, Normal `1/0/11`, and Fast `3/5/4`; every exact move pair still stayed at count `1`, so the seed only mixed one-off direct-Pro white `l9,6;l8,7` vs `l9,5;l7,6;l8,7`, one-off direct-Pro early-black `negative_deny` `l0,5;l1,6` vs `l1,5;l3,6;l2,7`, one-off Normal white spirit-own-setup `l9,5;l7,4;l8,3` vs `l9,5;l7,6;l7,7`, and one-off Fast black spirit sibling `l0,4;l1,3` vs `l0,4;l1,4`, black spirit-bridge `l1,5;l1,7;l0,7` vs `l4,1;l5,0;mb`, and black `ManaTempo` tie `l2,7;l2,8` vs `l2,7;l1,8`
  - do not spend from `pro_turn_planner_reliability_v47`; direct Pro finished `1/4/7`, Normal `3/3/6`, and Fast `4/2/6`; Normal did repeat the old black spirit-bridge seam `l1,5;l1,7;l0,7` vs current `l4,1;l5,0;mb` twice, but that is still the already-killed bridge-fallback family, while direct Pro only had one-off black accepted `ManaTempo` rerank `l0,5;l1,5` vs `l2,2;l3,3`, and Fast split across one-off black drainer-safety `l1,4;l0,5` vs `l4,1;l5,0;mb`, one-off black spirit-bridge `l1,5;l1,7;l0,7` vs `l4,1;l5,0;mb`, one-off white `l10,4;l9,3` vs `l9,5;l7,6;l8,7`, and one-off black `ManaTempo` tie `l2,7;l2,8` vs `l7,1;l6,1`
  - do not spend from `pro_turn_planner_reliability_v48`; direct Pro finished `4/4/4`, Normal finished clean at `0/0/12`, and Fast finished clean at `0/4/8`; every exact move pair still stayed at count `1`, so the seed only mixed one-off direct-Pro black `ManaTempo` tie `l2,3;l2,2` vs `l2,3;l1,2`, one-off white `l10,5;l9,4` vs `l9,8;l7,6;l7,7`, one-off white `l4,9;l2,7;l2,8` vs `l4,9;l2,7;l3,6`, and one-off white `l6,3;l7,2` vs `l6,5;l7,4`
  - do not spend from `pro_turn_planner_reliability_v49`; direct Pro finished `1/6/5`, Normal `7/0/5`, and Fast `1/3/8`; every exact move pair still stayed at count `1`, so the seed only mixed one-off direct-Pro black bridge-like rerank `l1,5;l1,7;l0,7` vs `l5,1;l6,0`, one-off Normal black spirit-bridge `l1,5;l1,7;l0,7` vs `l4,1;l5,0;mb`, one-off Normal black `l1,5;l1,7;l0,7` vs `l4,2;l4,1`, one-off Normal black `l2,5;l0,6;l1,6` vs `l2,5;l2,3;l1,2`, one-off Normal black spirit sibling `l0,4;l1,3` vs `l0,4;l1,4`, one-off Normal black `ManaTempo` tie `l2,7;l2,8` vs `l2,7;l1,8`, one-off Normal white `l8,7;l7,8` vs `l10,7;l10,8`, one-off Normal white spirit-own-setup `l9,5;l7,4;l8,3` vs `l9,5;l7,6;l7,7`, and one-off Fast black spirit sibling `l0,4;l1,3` vs `l0,4;l1,5`
  - do not spend from `pro_turn_planner_reliability_v50`; direct Pro finished `3/4/5`, Normal `3/3/6`, and Fast `3/2/7`; Normal did repeat a new white `ManaTempo` tie `l6,5;l6,6` vs current `l6,5;l7,4` twice, but Pro and Fast did not line up behind it: direct Pro split across one-off white `l10,5;l9,4` vs `l9,2;l8,1`, one-off white `l9,4;l8,5` vs `l8,1;l7,0`, and one-off white forced-prepass `l9,5;l8,3;l7,2` vs `l9,2;l8,1`, while Fast split across one-off black `l2,7;l1,8` vs `l2,3;l3,2`, one-off white `l9,6;l8,5` vs `l9,5;l8,5`, and one-off black `l0,6;l1,6` vs `l1,5;l2,5`
  - do not spend from `pro_turn_planner_reliability_v51`; direct Pro finished `3/2/7`, Normal `3/2/7`, and Fast `3/5/4`; Fast did repeat the old black spirit-bridge seam `l1,5;l1,7;l0,7` vs current `l4,1;l5,0;mb` twice, but that family already failed both the broad bridge fallback and the later spirit-only bridge fallback, while direct Pro still split across one-off black spirit-bridge, one-off early-black `negative_deny` `l0,5;l1,6` vs `l1,5;l3,6;l2,7`, and one-off white spirit-own-setup `l9,7;l8,5;l7,4` vs `l9,7;l7,6;l7,7`, and Normal split across one-off black drainer-safety `l1,6;l0,5` vs `l4,1;l5,0;mb`, one-off white engine-disabled tie `l8,7;l8,8` vs `l9,5;l8,6`, and the old white forced-prepass shell `l9,4;l8,5` vs `l9,4;l8,3`
  - do not spend from `pro_turn_planner_reliability_v52`; direct Pro finished `3/3/6`, Normal `3/5/4`, and Fast `4/4/4`; every exact move pair still stayed at count `1`, so the seed only mixed one-off direct-Pro early-black `negative_deny` `l0,5;l1,6` vs current `l1,5;l3,6;l2,7`, one-off direct-Pro black action+mana `l1,6;l2,7` vs `l2,3;l3,2`, one-off direct-Pro black spirit sibling `l0,4;l1,4` vs `l0,4;l1,5`, one-off Normal white engine-disabled tie `l6,3;l7,3` vs `l7,7;l8,8`, one-off Normal white forced-prepass `l9,6;l8,5` vs `l9,6;l8,7`, one-off Normal black mana-bridge `l0,5;l1,4` vs `l4,1;l5,0;mb`, and one-off Fast black spirit sibling `l0,4;l1,3` vs `l0,4;l1,4`, black `negative_deny` `l0,5;l1,6` vs `l1,5;l3,6;l2,7`, black drainer-safety `l1,4;l0,5` vs `l4,1;l5,0;mb`, and black `ManaTempo` tie `l2,7;l2,8` vs `l2,7;l1,8`
  - do not spend from `pro_turn_planner_reliability_v53`; direct Pro finished `1/4/7`, Normal `5/2/5`, and Fast finished clean at `0/4/8`; the only direct-Pro regression was the old black mana-bridge seam `l0,5;l1,4` vs current `l4,1;l5,0;mb`, but Normal exploded into count-`1` seams across that same bridge family, the old black spirit-bridge `l1,5;l1,7;l0,7` vs `l4,1;l5,0;mb`, black action+mana `l1,6;l2,7` vs `l3,2;l4,1`, black `ManaTempo` tie `l2,7;l2,8` vs `l2,7;l1,8`, and a white forced-prepass rerank `l9,6;l10,5` vs `l9,6;l8,7`, so there is still no repeated exact family or fresh shared lever
  - do not spend from `pro_turn_planner_reliability_v54`; direct Pro finished `4/4/4`, Normal `4/1/7`, and Fast `5/4/3`; every exact move pair still stayed at count `1`, so the seed only mixed one-off direct-Pro black bridge-like `l1,5;l1,7;l0,7` vs current `l5,1;l6,0`, one-off direct-Pro early-black `negative_deny` `l0,5;l1,6` vs `l1,5;l3,6;l2,7`, one-off direct-Pro white `ManaTempo` reranks `l9,3;l8,2` vs `l8,5;l9,4` and `l8,5;l8,6` vs `l8,5;l9,4`, one-off Normal black spirit rerank `l2,5;l0,6;l1,6` vs `l2,5;l2,3;l1,2`, one-off Normal black `ManaTempo` tie `l2,7;l2,8` vs `l2,7;l1,8`, one-off Normal white reranks `l8,6;l7,7` vs `l8,6;l8,5` and `l9,5;l7,4;l8,3` vs `l9,5;l7,6;l7,7`, and one-off Fast white forced-prepass/`ManaTempo` drifts `l8,4;l8,5` vs `l8,4;l9,3`, `l8,4;l8,5` vs `l8,4;l8,3`, `l9,4;l8,3` vs `l9,4;l8,4`, plus one-off black drainer-safety `l1,6;l0,5` vs `l4,1;l5,0;mb` and black `ManaTempo` tie `l2,7;l2,8` vs `l2,7;l1,8`
  - do not spend from `pro_turn_planner_reliability_v55`; direct Pro finished `3/5/4`, Normal `4/5/3`, and Fast `4/2/6`; every exact move pair still stayed at count `1`, so the seed only mixed one-off direct-Pro black spirit sibling `l0,4;l1,3` vs current `l0,4;l1,5`, one-off direct-Pro white reranks `l10,5;l9,4` vs `l9,2;l8,1` and `l10,6;l9,5` vs `l10,5;l9,4`, one-off Normal black spirit rerank `l2,5;l0,6;l1,6` vs `l2,5;l2,3;l1,2`, one-off Normal black `ManaTempo` tie `l2,7;l2,8` vs `l2,7;l1,8`, one-off Normal black mana-bridge `l0,5;l1,4` vs `l4,1;l5,0;mb`, one-off Normal white spirit-own-setup `l9,5;l7,4;l8,3` vs `l9,5;l7,6;l7,7`, and one-off Fast black spirit-bridge `l1,5;l1,7;l0,7` vs `l4,1;l5,0;mb`, black action+mana `l1,6;l2,7` vs `l2,3;l3,2`, plus white forced-prepass drifts `l9,4;l8,5` vs `l8,4;l7,6;l6,6` and `l9,4;l8,5` vs `l9,4;l8,3`
  - do not spend from `pro_turn_planner_reliability_v56`; direct Pro finished `3/3/6`, Normal `2/4/6`, and Fast `3/0/9`; direct Pro did repeat one white pair `l10,5;l9,4` vs current `l9,5;l7,4;l8,3` twice, but Normal and Fast did not line up behind it, and every non-Pro exact move pair still stayed at count `1`; the rest of the seed only mixed one-off direct-Pro black `ManaTempo` tie `l2,7;l2,6` vs `l2,7;l3,8`, one-off Normal black spirit rerank `l2,5;l0,6;l1,6` vs `l2,5;l2,3;l1,2`, one-off Normal white spirit-own-setup `l9,5;l7,4;l8,3` vs `l9,5;l7,6;l7,7`, one-off Fast black mana-bridge `l0,5;l1,4` vs `l4,1;l5,0;mb`, one-off Fast black `ManaTempo` tie `l2,7;l2,8` vs `l2,7;l1,8`, and one-off Fast white forced-prepass `l8,4;l8,5` vs `l8,4;l8,3`
  - do not spend from `pro_turn_planner_reliability_v57`; direct Pro finished `2/3/7`, Normal `2/2/8`, and Fast finished clean at `0/2/10`; what first looked like a repeated direct-Pro white family did not repeat at all, and every exact move pair across all three buckets stayed at count `1`; the seed only mixed one-off direct-Pro white reranks `l9,5;l7,4;l7,3` vs current `l9,5;l7,6;l7,7` and `l8,1;l7,0` vs `l9,4;l8,3`, one-off Normal white `l9,6;l8,5` vs `l9,7;l7,6;l7,7`, one-off Normal black `l3,2;l3,4;l2,3` vs `l3,2;l4,1`, and no Fast regressions at all
  - do not spend from `pro_turn_planner_reliability_v58`; direct Pro finished `3/5/4`, Normal `5/2/5`, and Fast `4/3/5`; direct Pro did repeat the retained early-black `negative_deny` seam `l0,5;l1,6` vs current `l1,5;l3,6;l2,7` twice, and Fast did repeat the already-killed black spirit-bridge seam `l1,5;l1,7;l0,7` vs `l4,1;l5,0;mb` twice, but Normal stayed pure count-`1` churn across white `l9,5;l8,5` vs `l9,5;l7,6;l7,7`, white forced-prepass `l9,4;l8,5` vs `l9,4;l8,3`, white spirit-own-setup `l9,5;l7,4;l8,3` vs `l9,5;l7,6;l7,7`, white `ManaTempo` tie `l8,5;l8,4` vs `l8,5;l9,4`, and white `l9,5;l8,4` vs `l9,6;l7,7;l7,8`, so the seed still split across already-known families instead of exposing one new shared lever
  - do not spend from `pro_turn_planner_reliability_v59`; direct Pro finished `2/2/8`, Normal `1/1/10`, and Fast `5/3/4`, and every exact move pair still stayed at count `1`; direct Pro only mixed one-off retained early-black `negative_deny` `l0,5;l1,6` vs current `l1,5;l3,6;l2,7` with one-off white forced-prepass `l8,4;l8,5` vs `l8,4;l9,3`, Normal only added one-off black spirit-bridge `l1,5;l1,7;l0,7` vs `l4,1;l5,0;mb`, and Fast broke across one-off white `l10,4;l9,3` vs `l9,5;l7,6;l8,7`, one-off black `l2,7;l1,8` vs `l2,3;l3,2`, one-off white forced-prepass `l8,4;l8,5` vs `l8,4;l9,3`, one-off white forced-prepass `l9,4;l8,5` vs `l9,4;l8,3`, and one-off white safe-progress `l9,5;l8,6` vs `l10,6;l9,6`, so the seed never collapsed onto one shared retained family
  - do not spend from `pro_turn_planner_reliability_v60`; direct Pro finished `3/3/6`, Normal `3/2/7`, and Fast `1/6/5`, and every exact move pair still stayed at count `1`; direct Pro split across one-off white `l8,4;l9,3` vs current `l8,5;l6,7;l7,7`, one-off retained early-black `negative_deny` `l0,5;l1,6` vs `l1,5;l3,6;l2,7`, and one-off black mana-bridge `l0,5;l1,4` vs `l4,1;l5,0;mb`; Normal split across one-off black action+mana `l1,6;l2,7` vs `l3,2;l4,1`, one-off white forced-prepass `l9,4;l8,5` vs `l9,4;l8,3`, and one-off black `ManaTempo` rerank `l0,10;l0,9` vs `l1,5;l2,5`; Fast only added one-off black action+mana `l1,6;l2,7` vs `l2,3;l3,2`, so the seed still never converged onto a shared retained family
  - do not spend from `pro_turn_planner_reliability_v61`; direct Pro finished `2/5/5`, Normal `2/2/8`, and Fast `4/1/7`, and every exact move pair still stayed at count `1`; direct Pro only repeated the retained early-black `negative_deny` seam `l0,5;l1,6` vs current `l1,5;l3,6;l2,7` twice, while Normal split across one-off black spirit-bridge `l1,5;l1,7;l0,7` vs `l4,1;l5,0;mb` and one-off white `l9,5;l8,5` vs `l9,5;l7,6;l7,7`, and Fast split across one-off white forced-prepass `l9,4;l8,5` vs `l9,4;l8,3`, one-off white forced-prepass `l8,4;l8,5` vs `l8,4;l9,3`, one-off black spirit-bridge `l1,5;l1,7;l0,7` vs `l4,1;l5,0;mb`, and one-off black spirit variant `l1,5;l0,7;l1,7` vs `l3,2;l4,1`, so the seed still broke across already-known families instead of exposing a shared retained lever
  - do not spend from `pro_turn_planner_reliability_v62`; direct Pro finished `1/2/9`, Normal `3/0/9`, and Fast `1/3/8`, and every exact move pair still stayed at count `1`; direct Pro only had one-off black `ManaTempo` sibling `l2,3;l2,2` vs current `l2,3;l1,2`, Normal split across one-off white `l8,5;l8,6` vs `l10,6;l9,6`, one-off black action+mana `l1,6;l2,7` vs `l3,2;l4,1`, and one-off white spirit-own-setup `l9,5;l7,4;l7,3` vs `l9,5;l7,6;l7,7`, while Fast only added one-off bridge-adjacent black spirit variant `l1,5;l1,7;l2,6` vs `l5,0;l4,1`, so the seed still never converged onto a shared retained family
...
- Do not reopen:
  ...
  - do not spend from `pro_turn_planner_reliability_v63`; direct Pro finished `2/3/7`, Normal `5/1/6`, and Fast `3/5/4`; the only repeated exact pair was the already-killed Normal black spirit-bridge seam `l1,5;l1,7;l0,7` vs current `l4,1;l5,0;mb` twice, while direct Pro stayed count-`1` on black `l1,5;l3,4;l2,3` vs `l1,5;l3,6;l2,7` and late white safe-progress `l10,5;l9,6` vs `l10,6;l9,5`, Normal added one-off white `l8,4;l9,3` vs `l5,9;l7,7;l8,8`, one-off black spirit sibling `l0,4;l1,4` vs `l0,4;l1,5`, and one-off white forced-prepass `l9,4;l8,5` vs `l9,4;l8,3`, and Fast split across one-off white `l10,4;l9,3` vs `l9,5;l7,6;l8,7`, one-off white forced-prepass `l8,6;l7,5` vs `l8,6;l7,7`, and one-off black accepted `ManaTempo` rerank `l1,5;l1,4` vs `l3,2;l4,1`
  - do not spend from `pro_turn_planner_reliability_v64`; direct Pro finished `1/4/7`, Normal `2/2/8`, and Fast `1/3/8`; every exact move pair stayed at count `1`, so the seed only mixed one-off direct-Pro black drainer-safety `l0,5;l1,4` vs current `l2,8;l3,8`, one-off Normal white spirit-own-setup `l9,5;l7,4;l8,3` vs `l9,5;l7,6;l7,7`, one-off Normal black spirit rerank `l2,5;l0,6;l1,6` vs `l2,5;l2,3;l1,2`, and one-off Fast black mana-bridge `l0,5;l1,4` vs `l4,1;l5,0;mb`
  - do not spend from `pro_turn_planner_reliability_v65`; direct Pro finished `1/3/8`, Normal `2/3/7`, and Fast `3/4/5`; every exact move pair stayed at count `1`, so the seed only mixed one-off direct-Pro black `ManaTempo` tie `l1,2;l1,1` vs current `l1,2;l0,1`, one-off Normal black accepted `ManaTempo` rerank `l0,9;l0,10` vs `l2,5;l4,3;l3,3`, one-off Normal white `ManaTempo` tie `l8,3;l8,2` vs `l8,3;l9,2`, and Fast one-offs on black `ManaTempo` tie `l1,8;l1,9` vs `l1,8;l0,9`, white `ManaTempo` tie `l8,5;l7,4` vs `l8,5;l9,4`, and black bridge-adjacent drainer-safety `l0,5;l1,4` vs `l4,1;l5,0;mb`
  - do not spend from `pro_turn_planner_reliability_v66`; direct Pro finished `1/4/7`, Normal `4/1/7`, and Fast `3/2/7`; the only repeated exact pair was the Normal white spirit-own-setup rerank `l9,5;l7,4;l8,3` vs current `l9,5;l7,6;l7,7` twice, while direct Pro stayed count-`1` on black accepted spirit `l1,4;l0,6;l1,6` vs `l5,10;l6,9`, Normal also added one-off white `ManaTempo` tie `l9,2;l9,1` vs `l9,2;l10,1` and one-off black spirit-bridge `l1,5;l1,7;l0,7` vs `l4,1;l5,0;mb`, and Fast split across one-off black mana-bridge `l0,5;l1,4` vs `l4,1;l5,0;mb`, one-off white forced-prepass `l7,4;l8,5` vs `l7,4;l8,3`, and one-off black `ManaTempo` rerank `l1,5;l2,5` vs `l1,6;l0,6`
