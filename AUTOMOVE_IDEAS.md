...
- current active Fast lower-live safe-step / ManaTempo pressure, ProV4 root-pool, policy-root-pool, guarded-delta, root-ordering profile, root-aspiration windowing, drainer walk-threat safety filtering, tactical quiescence toggles, forced tactical prepass, futility-pruning toggles, quiet-reduction toggles, selective-extension toggles, root-allocation toggles, deterministic interview-tiebreak toggles, PVS/search-ordering toggles, depth-consensus root stability, forced drainer-attack pressure, root-breadth config rebalancing, targeted exact-turn / score-window narrowing, child-ordering shortlist tuning, move-efficiency delta, scoring-context robustness, objective latency, bounded followup/reply breadth, root-preservation, reply-floor, reply-floor/progress, root-safety, utility/rank, cross-budget static-eval consensus, turn-completion stability, two-turn resilience, forced-root feature-axis, root-pool provenance, forced-root pool JSONL, root trajectory, race geometry, root-pool contrast, outcome contrast, family-overlap, state-discriminator, broad token, vulnerable-baseline token, or utility/rank token-pair evidence;
