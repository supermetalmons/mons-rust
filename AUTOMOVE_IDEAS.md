...
- Immediate next split:
  ...
  - do not spend from `pro_turn_planner_reliability_v36`; direct Pro finished clean at `0/3/9`, but Normal fell to `3/3/6` and Fast to `4/0/8`, with every exact move pair still at count `1`; the seed only remixed one-off black mana-bridge `l0,5;l1,4` vs `l4,1;l5,0;mb`, one-off black `ManaTempo` tie `l2,7;l2,8` vs `l2,7;l1,8`, one-off white forced-prepass `l8,4;l8,5` vs `l8,4;l8,3`, one-off early-black `negative_deny` `l0,5;l1,6` vs `l1,5;l3,6;l2,7`, and one-off white `l8,5;l8,4` sibling reranks vs `l8,5;l9,4` / `l8,5;l7,4`
